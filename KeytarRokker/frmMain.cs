...
namespace KeytarRokker
{
    public partial class frmMain : Form
    {
        ...
        private Bitmap RESOURCE_NOTE_ORANGE;
        private Bitmap RESOURCE_NOTE_BLUE;
        private Bitmap RESOURCE_NOTE_YELLOW;
        private Bitmap RESOURCE_NOTE_RED;
        private Bitmap RESOURCE_NOTE_GREEN;
        ...
        private int stageKitUserIndex = 0;
        private GamepadButtons _prevButtons = 0;
        ...
        private void LoadImages()
        {
            ...
            try
            {
                RESOURCE_BACKGROUND = Tools.NemoLoadImage(res + "background.jpg");
                RESOURCE_TRACK = Tools.NemoLoadImage(res + "track.jpg");
                RESOURCE_TRACK_SOLO = Tools.NemoLoadImage(res + "solo.png");
                RESOURCE_HITBOX = Tools.NemoLoadImage(res + "hitbox.png");
                RESOURCE_NOTE_ORANGE = Tools.NemoLoadImage(res + "note_orange.png");
                RESOURCE_NOTE_BLUE = Tools.NemoLoadImage(res + "note_blue.png");
                RESOURCE_NOTE_YELLOW = Tools.NemoLoadImage(res + "note_yellow.png");
                RESOURCE_NOTE_RED = Tools.NemoLoadImage(res + "note_red.png");
                RESOURCE_NOTE_GREEN = Tools.NemoLoadImage(res + "note_green.png");
                RESOURCE_NOTE_WHITE = Tools.NemoLoadImage(res + "note_white.png");
                RESOURCE_NOTE_BLACK = Tools.NemoLoadImage(res + "note_black.png");
                RESOURCE_NOTE_WHITE_OD = Tools.NemoLoadImage(res + "note_white_od.png");
                RESOURCE_NOTE_BLACK_OD = Tools.NemoLoadImage(res + "note_black_od.png");
                RESOURCE_KEYTAR = Tools.NemoLoadImage(res + "keytar.png");
                RESOURCE_LCD = Tools.NemoLoadImage(res + "lcd.png");
                RESOURCE_SCROLL = Tools.NemoLoadImage(res + "scroll.png");
                RESOURCE_SCROLL_ACTIVE = Tools.NemoLoadImage(res + "scroll_act1.png");
                RESOURCE_SCROLL_ACTIVE2 = Tools.NemoLoadImage(res + "scroll_act2.png");
                RESOURCE_BUTTON_PLAY = Tools.NemoLoadImage(res + "button_play.png");
                RESOURCE_BUTTON_PAUSE = Tools.NemoLoadImage(res + "button_pause.png");
                RESOURCE_BUTTON_LOAD = Tools.NemoLoadImage(res + "button_load.png");
                RESOURCE_BUTTON_MUTE = Tools.NemoLoadImage(res + "button_mute.png");
                RESOURCE_BUTTON_LIGHT = Tools.NemoLoadImage(res + "button_light.png");
                RESOURCE_BUTTON_UP = Tools.NemoLoadImage(res + "button_up.png");
                RESOURCE_BUTTON_DOWN = Tools.NemoLoadImage(res + "button_down.png");
                RESOURCE_POWER_ON = Tools.NemoLoadImage(res + "power_on.png");
                RESOURCE_POWER_OFF = Tools.NemoLoadImage(res + "power_off.png");
                RESOURCE_VOLUME = Tools.NemoLoadImage(res + "volume.png");
                RESOURCE_PEDAL_ON = Tools.NemoLoadImage(res + "pedal_on.png");
                RESOURCE_PEDAL_OFF = Tools.NemoLoadImage(res + "pedal_off.png");
            }
            catch (Exception)
            {
            ...
            for (var i = 0; i < 25; i++)
            {
                ...
                try
                {
                    ...
                    {                        
                        ...
                        //STREAMS[i] = Bass.BASS_SampleLoad(ogg, 0L, ogg.Length, 1, BASSFlag.BASS_SAMPLE_FLOAT);
                    }
        ...
        private void ConnectionTimer_Tick(object sender, EventArgs e)
        {
            try
            {
                player1.Enabled = XInput.GetCapabilities(0, DeviceQueryType.Any, out _);
                player2.Enabled = XInput.GetCapabilities(1, DeviceQueryType.Any, out _);
                player3.Enabled = XInput.GetCapabilities(2, DeviceQueryType.Any, out _);
                player4.Enabled = XInput.GetCapabilities(3, DeviceQueryType.Any, out _);
            ...
            try
            {
                if (XInput.GetCapabilities(stageKitUserIndex, DeviceQueryType.Any, out _))
                {
        ...
        private void updater_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            using (var client = new WebClient())
            {
                try
                {
                    client.DownloadFile("https://nemosnautilus.com/keytar/update.txt", path);
                }
                catch (Exception)
                { }
            }
        ...
        private void PlaySample(int key, int velocity)
        {
            ...
            else
            {
                try
                {
                    ...
                    // disable playback buffering for increased performance
                    Bass.BASS_ChannelSetAttribute(STREAMS[key], BASSAttribute.BASS_ATTRIB_BUFFER, 0);
                    Bass.BASS_ChannelPlay(STREAMS[key], true);
                    //var chan = Bass.BASS_SampleGetChannel(STREAMS[key], 0);
                    //Bass.BASS_ChannelStart(chan);
        ...
        private static Byte LoByte1(Int16 nValue)
        {
            return (Byte)(nValue & 0xFF);
        }

        private static Byte HiByte1(Int16 nValue)
        {
        ...
        void PollKeytar()
        {
            if (!XInput.GetState(stageKitUserIndex, out var state))
            {
                // disconnected
                _prevButtons = 0;
                return;
            ...
            bool Pressed(GamepadButtons b) => (buttons & b) != 0;
            bool WasPressed(GamepadButtons b) => (_prevButtons & b) != 0;
            bool JustPressed(GamepadButtons b) => Pressed(b) && !WasPressed(b);

            // None?
            if (buttons == 0)
            {
                STATE_START = STATE_BACK = STATE_RIGHT = STATE_LEFT = STATE_UP = STATE_DOWN =
                STATE_BUTTON_X = STATE_BUTTON_Y = STATE_BUTTON_A = STATE_BUTTON_B = false;
            }

            // D-Pad Left
            if (JustPressed(GamepadButtons.DPadLeft))
            {
                STATE_LEFT = true;
                picAudioUp_MouseClick(null, new MouseEventArgs(MouseButtons.Left, 1, 0, 0, 0));
            }
            // D-Pad Right
            if (JustPressed(GamepadButtons.DPadRight))
            {
                STATE_RIGHT = true;
                picAudioDown_MouseClick(null, new MouseEventArgs(MouseButtons.Left, 1, 0, 0, 0));
            }
            // D-Pad Up
            if (JustPressed(GamepadButtons.DPadUp))
            {
                STATE_UP = true;
                picOctaveUp_MouseClick(null, new MouseEventArgs(MouseButtons.Left, 1, 0, 0, 0));
            }
            // D-Pad Down
            if (JustPressed(GamepadButtons.DPadDown))
            {
                STATE_DOWN = true;
                picOctaveDown_MouseClick(null, new MouseEventArgs(MouseButtons.Left, 1, 0, 0, 0));
            }
            // Start
            if (JustPressed(GamepadButtons.Start))
            {
                STATE_START = true;
            ...
            // keep STATE_* booleans reflecting current holds (optional but tidy)
            STATE_LEFT = Pressed(GamepadButtons.DPadLeft);
            STATE_RIGHT = Pressed(GamepadButtons.DPadRight);
            STATE_UP = Pressed(GamepadButtons.DPadUp);
            STATE_DOWN = Pressed(GamepadButtons.DPadDown);
            STATE_START = Pressed(GamepadButtons.Start);
            STATE_BACK = Pressed(GamepadButtons.Back);
            STATE_BUTTON_X = Pressed(GamepadButtons.X);
            STATE_BUTTON_Y = Pressed(GamepadButtons.Y);
            STATE_BUTTON_A = Pressed(GamepadButtons.A);
            STATE_BUTTON_B = Pressed(GamepadButtons.B);
        ...
        private void KeysTimer_Tick(object sender, EventArgs e)
        {
            try
            {
                ...
                if (XInput.GetState(stageKitUserIndex, out var state))
                {
                    ...
                    // LeftThumbX is a short (-32768..32767). Your original HiByte&127 logic:
                    Velocity = HiByte(gamepad.LeftThumbX) & 0x7F;
                ...
                PollKeytar();
                // Assume: gamepad is Vortice.XInput.Gamepad from a successful XInput.GetState()

                // ---------------- PEDAL STATE ----------------
                // keytar (RightThumbY), MPA, keytar pedal
                bool hasPedal = gamepad.RightThumbY == 32640 ||
                                gamepad.RightThumbY == 128 ||
        ...
        // ---------------- HELPER FUNCTIONS ----------------
        static int LoByte(int value) => value & 0xFF;
        static int HiByte(int value) => (value >> 8) & 0xFF;
        static int LoByte(short value) => value & 0xFF;
        static int HiByte(short value) => (value >> 8) & 0xFF;
        ...
        private void songPreparer_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            cboCharts.Items.Add("Expert (" + MIDITools.MIDI_Chart.KeysX.ChartedNotes.Count + " notes)");
            cboCharts.Items.Add("Hard (" + MIDITools.MIDI_Chart.KeysH.ChartedNotes.Count + " notes)");
            cboCharts.Items.Add("Medium (" + MIDITools.MIDI_Chart.KeysM.ChartedNotes.Count + " notes)");
            cboCharts.Items.Add("Easy (" + MIDITools.MIDI_Chart.KeysE.ChartedNotes.Count + " notes)");
            cboCharts.Items.Add("Pro Expert (" + MIDITools.MIDI_Chart.ProKeysX.ChartedNotes.Count + " notes)");
            cboCharts.Items.Add("Pro Hard (" + MIDITools.MIDI_Chart.ProKeysH.ChartedNotes.Count + " notes)");
            cboCharts.Items.Add("Pro Medium (" + MIDITools.MIDI_Chart.ProKeysM.ChartedNotes.Count + " notes)");
            cboCharts.Items.Add("Pro Easy (" + MIDITools.MIDI_Chart.ProKeysE.ChartedNotes.Count + " notes)");
        ...
        private void loadCON()
        {
            ...
            if (!nautilus.DecM(xMogg, false, false, DecryptMode.ToMemory))
            {
        ...
        {
            StopPlayback();
            nautilus.ReleaseStreamHandle(false);
            nautilus.PlayingSongOggData = new byte[0];
            PlaybackSeconds = 0;
            SongLengthDouble = 0.0;
            SongLength = "";
            SongArtist = "";
        ...
        private long ProcessMogg()
        {
            try
            {
                var stream = Bass.BASS_StreamCreateFile(nautilus.GetOggStreamIntPtr(false), 0L, nautilus.PlayingSongOggData.Length, BASSFlag.BASS_STREAM_DECODE | BASSFlag.BASS_SAMPLE_FLOAT);
        ...
        private bool loadMIDI()
        {
            ...
            Tools.DeleteFile(TempMIDI);
            if (MIDITools.MIDI_Chart.ProKeysX.ChartedNotes.Count > 0 || MIDITools.MIDI_Chart.KeysX.ChartedNotes.Count > 0)
            {
                SongBPM = Math.Round(MIDITools.MIDI_Chart.AverageBPM, 1);
                return true;
            }            
            MessageBox.Show("That song doesn't have keys charted, nothing to play", AppName, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            StopEverything();
            return false;
        }
        ...
        private void DrawNotes(Graphics graphics)
        {
            ...
            for (var z = 0; z < track.ChartedNotes.Count(); z++)
            {
                ...
                int leftPos = 0;
                const int SPACER = 45;
                if (cboCharts.SelectedIndex < 4) //5 lane keys
                {
                    switch (note.NoteName)
                    {
                        ...
                        case "C6":
                        case "C5":
                            img = RESOURCE_NOTE_GREEN;
                            tailColor = Color.FromArgb(0, 255, 0);
                            leftPos = picC4b.Left - SPACER;
                            break;
                        case "C#8":
                            note.NoteNumber = 98;
                            img = RESOURCE_NOTE_RED;
                            tailColor = Color.FromArgb(255, 0, 0);
                            leftPos = picD4b.Left - SPACER;
                            break;
                        case "D8":
                            note.NoteNumber = 100;
                            img = RESOURCE_NOTE_YELLOW;
                            tailColor = Color.FromArgb(242, 226, 0);
                            leftPos = picE4b.Left - SPACER;
                            break;
                        case "D#8":
                            note.NoteNumber = 101;
                            img = RESOURCE_NOTE_BLUE;
                            tailColor = Color.FromArgb(0, 0, 255);
                            leftPos = picF4b.Left - SPACER;
                            break;
                        case "E8":
                            note.NoteNumber = 103;
                            img = RESOURCE_NOTE_ORANGE;
                            tailColor = Color.FromArgb(255, 126, 0);
                            leftPos = picG4b.Left - SPACER;
                            break;
                        case "C#7":
                            note.NoteNumber = 86;
                            img = RESOURCE_NOTE_RED;
                ...
                {
                    img = note.NoteName.Contains("#") ? (note.hasOD ? RESOURCE_NOTE_BLACK_OD : RESOURCE_NOTE_BLACK) : (note.hasOD ? RESOURCE_NOTE_WHITE_OD : RESOURCE_NOTE_WHITE);
                    tailColor = note.hasOD ? Color.LightGoldenrodYellow : (note.NoteName.Contains("#") ? Color.DimGray : Color.WhiteSmoke);
                }
                ...
                try
                {
                    if (leftPos == 0)
                    {
                        posX = NotePosX[note.NoteNumber - diff];
                    }
                    else
                    {
                        posX = leftPos;
                ...
                try
                {
                    posY = goalY - (((note.NoteStart - correctedTime) / PlaybackWindow) * goalY);
                }
                catch
                {
                    continue;
                ...
                if (note.NoteLength > note.TicksPerQuarterNote / 4.0) //longer than a 1/16 note
                {
                    ...
                    using (var solidBrush = new SolidBrush(tailColor))
                    {
                ...
                graphics.DrawImage(img, posX, (int)posY - img.Height + 3, img.Width, img.Height);
            }
        }
        
        private void StartPlayback()
        {
            if (nautilus.PlayingSongOggData.Count() == 0)
            {
            ...
            BassStream = Bass.BASS_StreamCreateFile(nautilus.GetOggStreamIntPtr(false), 0L, nautilus.PlayingSongOggData.Length, BASSFlag.BASS_STREAM_DECODE | BASSFlag.BASS_SAMPLE_FLOAT);
            ...
            var matrix = Tools.GetChannelMatrix(Parser.Songs[0], channel_info.chans, (silenceKeysTrack.Checked ? "" : "keys|") + "bass|guitar|vocals|drums|backing");
            ...
            // disable playback buffering for increased performance
            Bass.BASS_ChannelSetAttribute(BassMixer, BASSAttribute.BASS_ATTRIB_BUFFER, 0); 
        ...
        private void picTrack_Paint(object sender, PaintEventArgs e)
        {
            ...
            //draw range marker
            if (showRangeMarker.Checked && cboCharts.SelectedIndex > 3)
            {
                var correctedTime = GetCorrectedTime();
        ...
        private void cboCharts_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                case 0:
                    ActiveChart = MIDITools.MIDI_Chart.KeysX;
                    break;
                case 1:
                    ActiveChart = MIDITools.MIDI_Chart.KeysH;
                    break;
                case 2:
                    ActiveChart = MIDITools.MIDI_Chart.KeysM;
                    break;
                case 3:
                    ActiveChart = MIDITools.MIDI_Chart.KeysE;
                    break;
                case 4:
