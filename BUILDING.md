# Building Keytar Rokker from Source
...
git clone https://github.com/trojannemo/KeytarRokker.git
...
KeytarRokker\KeytarRokker\bin\Debug\

(or `Release` if building Release)

## Step 4: Open Solution
Open `KeytarRokker.sln` in Visual Studio.

If references are missing:
- Right-click project → Add Reference → Browse
- Point to the DLLs in `bin\Debug`

The main ones to look for are Naudio.dll, Naudio.Midi.dll, NautilusFREE.dll, and Bass.Net.dll.
...
I hope this helps more of you be able to compile and edit Keytar Rokker
